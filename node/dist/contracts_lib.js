...
(function() {
  var DEBUG, USE_NPM_SOLC, _, _string, c, capitalize, classify, config_path, contracts_conf_path, contracts_path, deasync, errCtrClassMismatch, fs, glob, log, path, solc, stringify;
  ...
  module.exports = function(web3) {
    var compileSolidityDeasynced, deleteAddressFromConf, eth, parseContract, readConfigs, readContracts;
    eth = web3.eth;
    ...
    parseContract = function(contract) {
      var abi, abi_methods, bytecode, compiled, contr, contract_class, function_hashes, gas_estimates, getters, methods, setters;
